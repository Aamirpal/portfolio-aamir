    ...
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content={
            data.keywords || "NestJS, NodeJS, ReactJs, Laravel, web development"
          }
        />
        ...
        <meta property="og:url" content={`https://aamirpal.com/blog/${slug}`} />
        <meta
          property="og:image"
          content={data.image || "https://aamirpal.com/default-image.jpg"}
        />
